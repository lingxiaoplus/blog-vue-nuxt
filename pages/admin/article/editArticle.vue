          ...
          <v-flex>
            <v-hover v-slot:default="{ hover }">
              <v-card class="pa-md-2" tile :elevation="hover?12:2">
                ...
                <v-card-actions>
                  ...
                  <v-btn color="green" dark tile @click="saveArticleToDrafts(1)">
                    发布
                  </v-btn>

                  <v-btn tile @click="preview">
                    预览
                  </v-btn>
                </v-card-actions>
              </v-card>
            ...
            <v-dialog v-model="web_dialog" max-width="500px">
              <v-card>
                ...
                <v-card-actions>
                  <v-btn tail class="ml-auto" color="primary" text @click="onDialogBingClick" :loading="bingLoading">选择bing图片</v-btn>
                </v-card-actions>
                <v-card-actions>
                  <v-spacer></v-spacer>
                ...
                <v-row>
                  <v-col v-for="image in bingImages" :key="image.url" class="d-flex child-flex" cols="3">
                    <v-card flat tile class="d-flex" @click="headPortrait = image.url" elevation="2">
                      ...
                      <v-btn v-if="headPortrait===image.url" absolute style="top: 10px" color="green" class="white--text" fab large right top>
